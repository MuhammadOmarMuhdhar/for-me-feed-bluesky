...
def collect_and_process_user_data(client: BlueskyUserDataClient, user_did: str, user_profile: Dict, app_password: str = None) -> Optional[Dict]:
    """Collect user posts and extract keywords (including likes if app password provided)"""
    try:
